# 1) Foundation: el Resource Group es el contenedor logico del ambiente staging.
...
# 3) Frontend staging: crea el recurso Azure Static Web Apps si la suscripcion lo permite.
