...
| Windows | ZIP `pos_fifo_system_C06.1_d69c73e791e5.zip`, SHA-256 `3ba925d4d120e47e730ee3959d7e8fd46925c98f363e0de05a1ba2b892a82f65` | C06.1 PASS: wheelhouse verificado offline, 32/32 migraciones y backup/restore antes y después sobre copia de desarrollo. Fuente: `C06.1-relevo-d69c73e-ensayo-completo.md`. No representa todavía una copia por tienda ni un artefacto aprobado para instalar. |
...
| --- | --- | --- |
| G1, entrada a staging | **Pendiente** | Corte de bloqueadores de este release, rig cloud/POS real y compatibilidad con POS instalado, migraciones/restore en copias representativas de cada POS y tenant, CI remoto y manifiesto/digest del RC. C06.1 cubre solo la copia de desarrollo. |
