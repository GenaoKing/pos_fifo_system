...
| Modulos vendibles | Fundación completa; CT03-SYNC validado en candidato aislado | `ARQUITECTURA_MODULOS.md` | CxC/reportes on-demand ya tienen gate HTML/API; C05/CT-04 ya está en el candidato consolidado. `1019500` cierra SUS-007/CFG-007 y `f83f67d` agrega el checkpoint read-only SUS-016; falta revisión/integración controlada y el cableado SUS-014. |
