...
class ConcurrenciaInventarioTests(TransactionTestCase):
    ...
    def setUp(self):
        ...
        # Materializa la config antes de lanzar hilos: ya no se crea sola al
        # leer (CFG-012), pero sigue conviniendo crearla aqui para no mezclar
        # su escritura con la carrera bajo prueba.
